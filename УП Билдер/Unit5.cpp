...
void __fastcall TForm5::FormActivate(TObject *Sender)
{
	...
	if(mode == 0)
	{
		Image4->Picture->LoadFromFile("просмотр информации опасити запрет.tif");
	   Image4->Enabled = false;
	}
	if(mode==1)
	{
		Image4->Picture->LoadFromFile("просмотр информации.tif");
       Image4->Enabled = true;
    }
}
//---------------------------------------------------------------------------
...
{
	Image1->Picture->LoadFromFile("добавить заказ.tif");
}
//---------------------------------------------------------------------------

void __fastcall TForm5::Image1MouseEnter(TObject *Sender)
{
	Image1->Picture->LoadFromFile("добавить заказ опасити.tif");
}
//---------------------------------------------------------------------------
...
void __fastcall TForm5::Image4MouseEnter(TObject *Sender)
{
	if(mode==1)
	{
       Image4->Picture->LoadFromFile("просмотр информации опасити.tif");
	}
...
{
	 Image2->Picture->LoadFromFile("назад в меню.tif");
}
//---------------------------------------------------------------------------
...
{
	 Image2->Picture->LoadFromFile("назад в главное меню опасити.tif");
}
//---------------------------------------------------------------------------

void __fastcall TForm5::Image3MouseEnter(TObject *Sender)
{
	 Image3->Picture->LoadFromFile("delete_zakaz опасити.png");
}
//---------------------------------------------------------------------------
